...
class ITableClasses(IClasses):
    ...
    container: str = cls("table-responsive")  # noqa
    table: str = cls("table", "table-striped", "table-hover")  # noqa
...
class DataTable(Snippet):
    ...
    def __init__(  # noqa
        self,
        headers: Optional[List[str]] = None,  # noqa
        page_length: Optional[int] = 10,  # noqa
        paging: Optional[bool] = True,  # noqa
        file_name: Optional[str] = 'datatable-export',  # noqa
        export: Optional[bool] = False,  # noqa
        classes: ITableClasses = ITableClasses(),  # noqa
    ) -> None:
        """
        Create table.
        ...
        with self:
            ...
            if export:
                datatable_render, exportcsvbutton = self.export_table(datatable_render)
            else:
    ...
    def _is_multilevel_header(self, headers: list) -> bool:  # noqa
    ...
    def add_row( # noqa
        self, title: Optional[str], columns: List[Union[str, int, float]]) -> tr:  # noqa
    ...
    def export_table(self, datatable_render) -> str:  # noqa
    ...
    @classmethod
    def from_pandas(cls, df: pd.DataFrame, use_index: bool = True, **kwargs):  # noqa
        """
    ...
    @classmethod
    def from_dict(cls, d: dict, use_index: bool = True, **kwargs):  # noqa
